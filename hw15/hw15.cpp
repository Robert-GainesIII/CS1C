...
public:
    ...
    {
        if(curr->val == rhs.value)return true;
        else return false;
    }
...
template<typename Elem> 
typename hw15::list<Elem>::iterator hw15::list<Elem>::begin()  // iterator to first element
{ 
...
template<typename Elem> 
typename const hw15::list<Elem>::iterator hw::15list<Elem>::begin() // iterator to first element
{ 
    return iterator(first); 
}
//------------------------------------------------------------------------------
...
template<typename Elem> 
typename hw15::list<Elem>::iterator hw15::list<Elem>::end() // iterator to one beyond last element
{ 
...
template<typename Elem> 
typename const hw15::list<Elem>::iterator hw15::list<Elem>::end()// iterator to one beyond last element
{ 
    return iterator(last); 
}
