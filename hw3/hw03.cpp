...
int main(){
    ...
    x = customConstructorEmployee == customConstructorProgrammer;
    customConstructorProgrammer.setPhoneNumber("949-234-2324");
    z = customConstructorEmployee == customConstructorProgrammer;
