...
void Employee::operator +(const int & number){
    age+=number;
    cout << number << " of years was added to " << employeeName << "'s age" << endl;
}

void Employee::addToAge(const int &){
    age+=number;
    cout << number << " of years was added to " << employeeName << "'s age" << endl;
}

bool arePhonesEqual(const Employee & lhs, const Employee & rhs){
    if(lhs.phoneNumber == rhs.getPhoneNumber()){
        cout << "The Phone numbers are equal." << endl;
        return true;
    }
    else{
...
&ostream operator <<(const ostream & out, const Employee & em){
    out <<"employeeName: " << em.employeeName << endl;
    out <<"employeeId: " << em.employeeId << endl;
    out <<"phoneNumber: " << em.phoneNumber << endl;
    out <<"jobTitle: " << em.jobTitle << endl;
    out <<"hireDate: " << em.hireDate << endl;
    out <<"age: " << em.age << endl;
    out <<"salary: " << em.salary << endl;
    out <<"gender: " << em.gender << endl;
}
&istream operator >>(const istream &, const Employee &){
