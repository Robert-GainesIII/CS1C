...
class Employee{
    ...
    friend bool arePhonesEqual(const Employee &, const Employee &);
    friend &ostream operator <<(const ostream &, const Employee &);
    friend &istream operator >>(const istream &, const Employee &);
