...
int main()
{
    ...
    //double * q = &x;
    //not allowed because double type pointer must point to double type data
   ...
   // double & s = x;
    //again doubles can only refer to doubles 
